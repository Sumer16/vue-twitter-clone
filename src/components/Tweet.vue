<template>
	<article class="border-b border-gray-600">
			...
			<section class="flex-1">
				...
				<div class="mt-2 flex items-center justify-between">
					<div class="text-gray-500">
						<i class="fas fa-comment p-2 mr-1 rounded-full hover:text-green-500 hover:bg-green-900"></i>
						<span>{{ tweet.stats.comments.length }}</span>
					</div>
					<div class="text-gray-500">
						<i class="fas fa-retweet p-2 mr-1 rounded-full hover:text-green-500 hover:bg-green-900"></i>
						<span>{{ tweet.stats.retweets.length }}</span>
					</div>
					<div class="text-gray-500">
						<i class="fas fa-heart p-2 mr-1 rounded-full hover:text-green-500 hover:bg-green-900"></i>
						<span>{{ tweet.stats.likes.length }}</span>
					</div>
					<div class="text-gray-500">
						<i class="fas fa-share p-2 mr-1 rounded-full hover:text-green-500 hover:bg-green-900"></i>
					</div>
				</div>
			</section>
		</router-link>
